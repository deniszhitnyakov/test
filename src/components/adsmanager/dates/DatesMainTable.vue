    ...
    <v-card>
      <v-card-text style="padding: 0px 8px 0px 8px">
        ...
        <v-data-table
          ...
          show-select
          class="elevation-1 stat-table stat-table-dates"
...
<style>
  ...
  .stat-table-dates div.v-data-table__wrapper > table > tbody > tr:hover > td:nth-child(1), 
  .stat-table-dates div.v-data-table__wrapper > table > tbody > tr:hover > td:nth-child(2) {
    background: #2a2a2a;
  }
